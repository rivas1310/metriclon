...
export default function CallbackPage() {
  ...
  useEffect(() => {
    ...
    console.log('Instagram Callback - Parámetros recibidos:');
    ...
    if (!code || !state) {
      console.log('Instagram Callback - Faltan parámetros');
    ...
    console.log('Instagram Callback - Redirigiendo a:', callbackUrl);
