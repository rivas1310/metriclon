    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(async () => {
          ...
          if (loginSuccess) {
            // El hook de auth redirigirá automáticamente al dashboard
          }
        }, 1000);
      } else {
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            Tu cuenta y organización han sido creadas. Iniciando sesión automáticamente...
          </p>
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Únete a la plataforma de Integración Social
          </p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="block w-full px-3 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors"
